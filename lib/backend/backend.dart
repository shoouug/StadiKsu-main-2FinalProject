...
import 'schema/stadium_record.dart';
...
export 'schema/stadium_record.dart';
export 'schema/reservation_record.dart';
export 'schema/user_record.dart';

/// Functions to query StadiumRecords (as a Stream and as a Future).
Future<int> queryStadiumRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      StadiumRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<StadiumRecord>> queryStadiumRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      StadiumRecord.collection,
      StadiumRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<StadiumRecord>> queryStadiumRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
